<div class='mp'>
    ...
    <ul>
        <li><a href="https://now.httpbin.org/" ><code>now.httpbin.org</code></a> The current time, in a variety of formats.</li>
    </ul>
    ...
    <ul>
        ...
        <li><a href="/uuid" ><code>/uuid</code></a> Returns UUID4.</li>
        ...
        <li><a href="{{ url_for('view_cookies') }}" ><code>/cookies</code></a> Returns cookie data.</li>
        ...
        <li><a href="{{ url_for('view_html_page') }}" ><code>/html</code></a> Renders an HTML Page.</li>
        <li><a href="{{ url_for('view_robots_page') }}" ><code>/robots.txt</code></a> Returns some robots.txt rules.</li>
        <li><a href="{{ url_for('view_deny_page') }}" ><code>/deny</code></a> Denied by robots.txt file.</li>
        <li><a href="{{ url_for('cache') }}" ><code>/cache</code></a> Returns 200 unless an If-Modified-Since or If-None-Match header is provided, when it returns a 304.</li>
